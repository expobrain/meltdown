...
describe('Compiler', function () {
    ...
    describe("#replaceReactRouter", function () {
        ...
        it("replace Link component with params", function () {
            var options = {
                replaceReactRouter: true
            };
            var expected = (
                '<a href="{% url \'my-route-name\' a=myVariable b=42 %}"></a>'
            );
            var frame = parser.parse(
                'var Component = React.createClass({' +
                '  render: () => {' +
                '    return (' +
                '      <Link to="my-route-name" params={{a: myVariable, b: 42}} />' +
                '    );' +
                '  }' +
                '});' +
                'module.exports = Component',
        ...
        it("replace Link component with empty alt", function () {
            var options = {
                replaceReactRouter: true
            };
            var expected = (
                '<a href="{% url \'my-route-name\' %}"></a>'
            );
            var frame = parser.parse(
                'var Component = React.createClass({' +
                '  render: () => {' +
                '    return (' +
                '      <Link to="my-route-name" alt />' +
                '    );' +
                '  }' +
                '});' +
                'module.exports = Component',
